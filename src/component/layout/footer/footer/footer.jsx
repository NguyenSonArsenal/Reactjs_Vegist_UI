                        ...
                        <div className="footer-service section-b-padding">
                            <ul className="service-ul">
                                <li className="service-li">
                                    <a href="javascript:void(0);"><i className="fa fa-truck"></i></a>
                                    <span>Free delivery</span>
                                </li>
                                <li className="service-li">
                                    <a href="javascript:void(0);"><i className="fa fa-rupee"></i></a>
                                    <span>Cash on delivery</span>
                                </li>
                                <li className="service-li">
                                    <a href="javascript:void(0);"><i className="fa fa-refresh"></i></a>
                                    <span>30 Days returns</span>
                                </li>
                                <li className="service-li">
                                    <a href="javascript:void(0);"><i className="fa fa-headphones"></i></a>
                        ...
                        <div className="f-logo">
                            <ul className="footer-ul">
                                <li className="footer-li footer-logo">
                                    <a href="index.html">
                                        <img className="img-fluid" src="/asset/image/logo1.png" alt="" />
                                    </a>
                                </li>
                            ...
                            <div className="footer-link" id="footer-accordian">
                                ...
                                <div className="f-link">
                                    ...
                                    <ul className="f-link-ul collapse" id="privacy" data-bs-parent="#footer-accordian">
                                        <li className="f-link-ul-li"><a href="payment-policy.html">Payment policy</a>
                                        </li>
                                        <li className="f-link-ul-li"><a href="privacy-policy.html">Privacy policy</a>
                                        </li>
                                        <li className="f-link-ul-li"><a href="return-policy.html">Return policy</a></li>
                                        <li className="f-link-ul-li"><a href="shipping-policy.html">Shipping policy</a>
                                        </li>
                                        <li className="f-link-ul-li"><a href="terms-conditions.html">Terms &
                                            conditions</a></li>
                                    </ul>
                                </div>
                                <div className="f-link">
